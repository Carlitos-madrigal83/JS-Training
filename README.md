...
4. Declara una constate de nombre `string` cuyo valor sea un una cadena de caracteres en minúscula, sin espacios ni caracteres especiales.
...
12. Declara ua variable de nombre `togleBoolean` cuyo valor sea la negación de la variable anteriornot
...
15. Declara una función de nombre `convertToKebabCase` que pueda recibir cualquier cantidad de parámetros y como mínimo dos. La función devolverá un string en *kebab-case* cuyo
